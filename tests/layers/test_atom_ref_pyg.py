...
def test_atom_ref(graph_MoSH_pyg):
...
def test_atom_ref_without_property_offset(graph_MoSH_pyg):
    _, g1, _ = graph_MoSH_pyg
...
def test_atom_ref_property_offset_as_list(graph_MoSH_pyg):
    _, g1, _ = graph_MoSH_pyg
...
def test_atom_ref_fit(graph_MoSH_pyg):
    _, g1, _ = graph_MoSH_pyg
    element_ref = AtomRefPyG(torch.tensor([0.5, 1.0, 2.0]))
...
def test_atom_ref_with_states(graph_MoSH_pyg):
    _, g1, _ = graph_MoSH_pyg
