...
def test_weighted_readout(graph_MoS):
    _, g1, _ = graph_MoS
...
def test_weighted_atom_readout(graph_MoS):
    _, g1, _ = graph_MoS
    bond_expansion = BondExpansion(rbf_type="SphericalBessel", max_n=3, max_l=3, cutoff=4.0, smooth=False)
    bond_basis = bond_expansion(g1.edata["bond_dist"])
    embed = EmbeddingBlock(
...
def test_readout_pair(graph_MoS):
    _, g1, _ = graph_MoS
    bond_expansion = BondExpansion(rbf_type="SphericalBessel", max_n=3, max_l=3, cutoff=4.0, smooth=False)
    bond_basis = bond_expansion(g1.edata["bond_dist"])
    node_attr = g1.ndata["node_type"]
...
def test_reduce_readout(graph_MoS):
    _, g1, _ = graph_MoS
    bond_expansion = BondExpansion(rbf_type="SphericalBessel", max_n=3, max_l=3, cutoff=4.0, smooth=False)
    bond_basis = bond_expansion(g1.edata["bond_dist"])
    embed = EmbeddingBlock(
...
def test_set2set_readout(graph_MoS):
    _, g1, _ = graph_MoS
    bond_expansion = BondExpansion(rbf_type="SphericalBessel", max_n=3, max_l=3, cutoff=4.0, smooth=False)
    bond_basis = bond_expansion(g1.edata["bond_dist"])
    embed = EmbeddingBlock(
...
def test_global_pool(graph_MoS):
    _, g1, _ = graph_MoS
    bond_expansion = BondExpansion(rbf_type="SphericalBessel", max_n=3, max_l=3, cutoff=4.0, smooth=False)
    bond_basis = bond_expansion(g1.edata["bond_dist"])
    embed = EmbeddingBlock(
...
def test_attentive_fp(graph_MoS):
    _, g1, _ = graph_MoS
    bond_expansion = BondExpansion(rbf_type="SphericalBessel", max_n=3, max_l=3, cutoff=4.0, smooth=False)
    bond_basis = bond_expansion(g1.edata["bond_dist"])
    embed = EmbeddingBlock(
